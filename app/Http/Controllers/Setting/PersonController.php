...
use App\Http\Requests\Setting\StorePersonRequest;
use App\Http\Requests\Setting\UpdatePersonRequest;
...
class PersonController extends Controller
{
    public function index()
    {
        ...
        return view('setting.people.index')
        ->with(compact('people'));
    }
    ...
    public function create()
    {
        $genders = Gender::all();
        $regions = Region::all();
        return view('setting.people.create')
    ...
    public function edit(Person $projectPerson)
    {
        ...
        $genders = Gender::all();
        $regions = Region::all();
        return view('setting.people.edit',[
