    ...
    <section class="content">
        ...
        <div class="box box-info">
            ...
            <div class="box-header with-border center-block">
                <h3 class="box-title"><strong>{{ __('messages.projectsAssignedTo') }} {{ $user->person->fullName }}</strong></h3> | 
            ...
            <div class="box-body">
                ...
                <a class="btn btn-danger btn-sm" href=" {{ route('user.index') }} "><<< {{ __('content.return') }}</a>
