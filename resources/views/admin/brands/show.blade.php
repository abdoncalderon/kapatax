            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="box-footer">
                        <a class="btn btn-success btn-sm" href=" {{ route('brands.edit', $brand) }} ">{{ __('content.edit') }}</a>
                        <a class="btn btn-info btn-sm" href=" {{ route('brands.index') }} ">{{ __('messages.returnToList') }}</a>
                    </div>
