            ...
            <div class="box box-info">
                ...
                <div class="box-header with-border">
                    ...
                    @if ($myQuotation->status_id==0)
                        <a class="btn btn-danger btn-sm" href="{{ route('myQuotations.accept',$myQuotation) }}">{{ __('content.reject') }}</a>
                        <a class="btn btn-success btn-sm" href="{{ route('myQuotations.reject',$myQuotation) }}">{{ __('content.accept') }}</a>
                    @endif
                ...
                {{-- Start Form  --}}
                                        ...
                                        <tbody>
                                            @foreach($myQuotation->quotationRequest->quotationRequestItems as $quotationRequestItem)
                                                <tr>
                                                    ...
                                                    @if ($myQuotation->status_id > 0)
                                                        <td>
                                                            <a class="btn btn-success btn-xs" href="{{ route('myQuotationItems.create', [$myQuotation, $quotationRequestItem] ) }}">{{ __('content.quote') }}</a>
                                                        </td>
                                                    @endif
                                                </tr>
                                            @endforeach
                    ...
                    <div class="box-footer">
                        ...
                        @if ($myQuotation->status_id == 1)
                            <a class="btn btn-success btn-sm" href="#">{{ __('messages.sendQuote') }}</a>
                        @endif
