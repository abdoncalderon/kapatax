    ...
    <section class="content">
        ...
        <div>
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('myNeedRequestItems.update',$myNeedRequestItem) }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-sm-4 col-md-6 col-lg-10">
                            ...
                            <input id="need_request" type="hidden" name="need_request_id" value="{{ $myNeedRequestItem->need_request_id }}">

                            {{--status --}}
    
                            <input id="status" type="hidden" name="status_id" value="{{ $myNeedRequestItem->status_id }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <textarea id="reference" class="form-control" name="reference" style="resize: vertical; height: 100px;" rows="5" required>{{ $myNeedRequestItem->reference }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="quantity" type="number" class="form-control" name="quantity" value="1" min="1" value="{{ $myNeedRequestItem->quantity }}" required>
                                </div>
                            </div>
                                    ...
                                    <select id="unity_id" class="form-control" name="unity_id" class="form-control" required>
                                        ...
                                        @foreach ($unities as $unity)
                                            <option value="{{ $unity->id }}"
                                                @if ($myNeedRequestItem->unity_id==$unity->id)
                                                    selected
                                                @endif    
                                            >{{ $unity->name }}</option>
                                        @endforeach
                    ...
                    <div class="box-footer">
                        ...
                        <a class="btn btn-danger btn-sm" href=" {{ route('myNeedRequests.edit',$myNeedRequestItem->needRequest) }} ">{{ __('content.cancel') }}</a>
                    </div>
