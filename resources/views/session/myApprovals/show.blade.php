...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('myNeedRequests.index')}}"> {{ __('messages.myApprobals') }} </a></li>
            ...
            <div class="box box-info">
                ...
                <div class="box-header with-border">
                    ...
                    @if ($needRequest->status_id==1)
                        <a class="btn btn-success btn-sm" href="{{ route('myApprovals.approval',[$needRequest->id,3]) }}">{{  __('content.approve') }}</a> 
                        <a class="btn btn-danger btn-sm" href="{{ route('myApprovals.approval',[$needRequest->id,2]) }}">{{  __('content.reject') }}</a>
                    @endif
                </div>
                ...
                {{-- Start Form  --}}
                    ...
                    <div class="box-footer">
                        <a class="btn btn-danger btn-sm" href=" {{ route('myApprovals.index') }} ">{{ __('content.return') }}</a>
