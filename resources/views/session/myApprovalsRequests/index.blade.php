                            ...
                            <tr>
                                ...
                                <td>
                                    @if ( $needRequest->status_id == 1 )
                                        <a class="btn btn-info btn-xs" href="{{ route('myApprovalRequests.show', $needRequest) }}">{{ __('content.review') }}</a>
                                    @else
                                        <a class="btn btn-default btn-xs" href="{{ route('myApprovalRequests.show', $needRequest) }}">{{ __('content.show') }}</a>
                                    @endif
