                    ...
                    <div class="box-body">
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="jobTitle" type="text" class="form-control @error('jobTitle') is-invalid @enderror" name="jobTitle" value="{{ $person->jobTitle }}" placeholder="{{ __('content.jobTitle') }}" autocomplete="off">
                                    @error('jobTitle')
                                        <span class="invalid-feedback" role="alert" style="color:red">
                                            <strong>{{ $message }}</strong>
                                        </span>
