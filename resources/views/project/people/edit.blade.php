    ...
    <section class="content">
        ...
        <div>
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('projectPeople.update',$projectPerson->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-9 col-md-9 col-lg-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="cardId" class="form-control @error('cardId') is-invalid @enderror" name="cardId" type="text" value="{{ $projectPerson->cardId }}" placeholder="{{ __('content.cardId') }}">
                                    @error('cardId')
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="firstName" class="form-control @error('firstName') is-invalid @enderror" name="firstName" type="text" value="{{ $projectPerson->firstName }}" placeholder="{{ __('content.firstNames') }}" autocomplete="off">
                                    @error('firstName')
                                        <span class="invalid-feedback" role="alert" style="color:red">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="lastName" class="form-control @error('lastName') is-invalid @enderror" name="lastName" type="text" value="{{ $projectPerson->lastName }}" placeholder="{{ __('content.lastNames') }}" autocomplete="off">
                                    @error('lastName')
                                        <span class="invalid-feedback" role="alert" style="color:red">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="fullName" class="form-control @error('fullName') is-invalid @enderror" name="fullName" type="text" value="{{ $projectPerson->fullName }}" placeholder="{{ __('content.fullName') }}" autocomplete="off">
                                    @error('fullName')
                                        <span class="invalid-feedback" role="alert" style="color:red">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <select id="gender" name="gender_id" class="form-control" style="width: 100%;">
                                        @foreach ($genders as $gender)
                                            <option value="{{ $gender->id }}"
                                                @if($gender->id==$projectPerson->gender_id)
                                                    selected
                                                @endif
                                            >{{ $gender->name }}</option>
                                        @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10">
                                    <input id="birthDate" class="form-control pull-right @error('birthDate') is-invalid @enderror" type="date" name="birthDate" value="{{ $projectPerson->birthDate }}">
                                    @error('birthDate')
                                        <span class="invalid-feedback" role="alert" style="color:red">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="jobTitle" type="text" class="form-control @error('jobTitle') is-invalid @enderror" name="jobTitle" value="{{ $projectPerson->jobTitle }}" placeholder="{{ __('content.jobTitle') }}" autocomplete="off">
                                    @error('jobTitle')
                                        <span class="invalid-feedback" role="alert" style="color:red">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"  value="{{ $projectPerson->email }}" placeholder="{{ __('content.email') }}">
                                    @error('email')
                                    ...
                                    <select id="region" name="region_id" class="form-control" style="width: 100%;">
                                        ...
                                        @foreach ($regions as $region)
                                            <option value="{{ $region->id }}"
                                                @if ($region->id==$projectPerson->city->state->country->region->id)
                                                    selected
                                                @endif
                                            >{{ $region->name }}</option>
                                        @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <select id="country" name="country_id" class="form-control" style="width: 100%;">
                                        <option value="{{ $projectPerson->city->state->country->id }}">{{ $projectPerson->city->state->country->name }}</option>
                                    </select>
                                    <span class="input-group-btn">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <select id="state" name="state_id" class="form-control" style="width: 100%;">
                                        <option value="{{ $projectPerson->city->state->id }}">{{ $projectPerson->city->state->name }}</option>
                                    </select>
                                    <span class="input-group-btn">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <select id="city" name="city_id" class="form-control" data-placeholder="Tipo" style="width: 100%;">
                                        <option value="{{ $projectPerson->city_id }}">{{ $projectPerson->city->name }}</option>
                                    </select>
                                    <span class="input-group-btn">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ $projectPerson->address }}" placeholder="{{ __('content.address') }}" autocomplete="off">
                                    @error('address')
                                        <span class="invalid-feedback" role="alert" style="color:red">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="homePhone" type="text" class="form-control @error('homePhone') is-invalid @enderror" name="homePhone" value="{{ $projectPerson->homePhone }}" placeholder="{{ __('content.homePhone') }}" autocomplete="off">
                                    @error('homePhone')
                                        <span class="invalid-feedback" role="alert" style="color:red">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="mobilePhone" type="text"  class="form-control @error('mobilePhone') is-invalid @enderror" name="mobilePhone" value="{{ $projectPerson->mobilePhone }}"  placeholder="{{ __('content.mobilePhone') }}" autocomplete="off">
                                    @error('mobilePhone')
                                        <span class="invalid-feedback" role="alert" style="color:red">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10" >
                                    @if (!is_active_stakeholder_person($projectPerson))
                                    ...
                                    @else
                                        <span class="badge">{{ __('messages.userIsActive').' - '.__('messages.admissionsNotAllowed') }}</span>
                                    @endif
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <input id="person_id" hidden type="text" name="person_id" value="{{ $projectPerson->id }}">
            ...
            <form method="POST" action="{{ route('users.add') }}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="person_id" value="{{ $projectPerson->id }}">
