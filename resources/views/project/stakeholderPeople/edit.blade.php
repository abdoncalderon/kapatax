            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('stakeholderPeople.update',$stakeholderPerson) }}">
                        ...
                        <div class="col-sm-4 col-md-6 col-lg-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10 col-md-1 col-lg-1">
                                    <input id="admissionhDate" class="form-control pull-right @error('admissionDate') is-invalid @enderror" type="date" name="admissionDate" value="{{ $stakeholderPerson->admissionDate }}" required>
                                    @error('admissionDate')
                    ...
                    <div class="box-footer">
                        ...
                        <a class="btn btn-danger btn-sm" href=" {{ route('projectPeople.edit',$stakeholderPerson->person) }} ">{{ __('content.cancel') }}</a>
                    </div>
