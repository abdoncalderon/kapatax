        ...
        <div>
            ...
            <div class="box box-info">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title"><strong>{{ __('content.add') }} {{ __('content.new') }} {{ __('content.family')}}</strong></h3>
                </div>
                ...
                <form class="form-horizontal" method="POST" action="{{ route('families.store') }}">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-sm-4 col-md-6 col-lg-10">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{{ __('content.families') }}</label>
                                <div class="col-sm-10" >
                    ...
                    <div class="box-footer">
                        ...
                        <a class="btn btn-danger btn-sm" href=" {{ route('families.index',$project) }} ">{{ __('content.cancel') }}</a>
                    </div>
