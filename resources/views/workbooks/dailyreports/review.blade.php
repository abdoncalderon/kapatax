                                            ...
                                            @foreach($dailyReport->comments as $commentDailyReport)
                                                @if($commentDailyReport->section=='report')
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($commentDailyReport->project_user_id==current_user()->id)
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input id="project_user_id" hidden type="text" name="project_user_id" value="{{ $dailyReport->project_user_id }}">
                        ...
                        <input id="approveddby" hidden type="text" name="approvedby" value="{{ current_user()->id }}">
