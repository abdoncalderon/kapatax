                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8" >
                                <select id="location" name="location" class="form-control" required style="width: 100%;" >
                                    ...
                                    @foreach (current_user()->locationProjectUsers as $locationProjectUser)
                                        <option value="{{ $locationProjectUser->location_id }}"
                                            @if($locationProjectUser->location_id==$location_id):
                                                selected="selected"
                                            @endif
                    ...
                    <tbody>
                        @foreach($folios as $folio)
                            <tr>
                                ...
                                <td>{{ $folio->status() }}</td>
                                <td>
                                    @if(is_valid_date_for_open_folio($folio->date,$folio->location))
