    ...
    <section class="content">
        ...
        <div class="box box-info">
            ...
            <div class="box-header with-border center-block">
                ...
                <a class="btn btn-success btn-sm" href="{{ route('locationTurns.create', $location) }}">{{ __('content.add') }}</a>
            </div>
                    ...
                    <tbody>
                        @foreach($location->turns as $turnlocation)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-danger btn-xs" href="{{ route('locationTurns.destroy', $turnlocation)}}">{{ __('content.delete')}}</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
