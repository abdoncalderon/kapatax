...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('quotationRequests.index')}}"> {{ __('messages.quotationRequests') }} </a></li>
                ...
                {{-- Start Form  --}}
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-sm-11 col-md-11 col-lg-11">
                            ...
                            <input id="status" type="hidden" name="status_id" value="{{ $quotationRequest->status_id }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="zone" disabled class="form-control" name="zone_id" type="text" value="{{ $quotationRequest->needRequest->location->zone->name }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="location" disabled class="form-control" name="location_id" type="text" value="{{ $quotationRequest->needRequest->location->name }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    {{-- <input id="cost_account" disabled class="form-control" name="cost_account_id" type="text" value="{{ $quotationRequest->costAccount->name }}"> --}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <textarea id="description" disabled class="form-control" name="description" style="resize: vertical; height: 100px;" >{{ $quotationRequest->needRequest->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="expectedCost" disabled class="form-control" name="expectedCost" type="number" value="{{ $quotationRequest->needRequest->expectedCost }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    <input id="approving_user" disabled class="form-control" name="approver_id" type="text" value="{{ $quotationRequest->needRequest->approver->person->fullName }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm col-xs-12 col-sm-10" >
                                    ...
                                    <table id="items" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            @foreach($quotationRequest->quotationRequestItems as $quotationRequestItem)
                                                <tr>
                                        ...
                                        <tbody>
                                            @foreach($notifications as $notification)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-danger btn-xs" href=" {{ route('quotationRequestNotifications.destroy',$notification) }} ">{{ __('content.delete') }}</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                    ...
                    <div class="box-footer">
                        <a class="btn btn-danger btn-sm" href=" {{ route('quotationRequests.index') }} ">{{ __('content.return') }}</a>
                        @if ($notifications->count()>0)
                            <a class="btn btn-success btn-sm" href=" {{ route('quotationRequests.dispatch',$quotationRequest) }} ">{{ __('content.dispatch') }}</a>
                        @endif
                    </div>
