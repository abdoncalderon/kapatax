...
class CreateQuotationRequestNotificationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('quotation_request_notifications', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('quotation_request_notifications');
    }
}
